...
var
  ...
  ParamWebBrowser: TMyBrowser;
  currency_code, EasyjetStartURL: string;
  ini : tinifile;
  iniPath:string;
  IsSuccess : boolean;
begin
  ...
  ParamWebBrowser := TMyBrowser.Create(Application.mainForm);
  try
...
//
    ...
    try
    paramWebBrowser.Navigate(EasyjetStartURL,EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
    try
    paramWebBrowser.Navigate('javascript:setCookie("eJ_orig",'+airport_depart+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
    try
    paramWebBrowser.Navigate('javascript:setCookie("eJ_orig_perm",'+airport_depart+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
    try
    paramWebBrowser.Navigate('javascript:setCookie("eJ_dest",'+airport_destination+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
    try
    paramWebBrowser.Navigate('javascript:setCookie("eJ_dest_perm",'+airport_destination+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
...
//
    ...
    until paramWebBrowser.ReadyState >= READYSTATE_COMPLETE;
    // Naviagate to source page
    paramWebBrowser.Navigate(EasyjetMainURL, EmptyParam, EmptyParam, EmptyParam, Headers);
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    Sleep(10);
    ...
    if Assigned(HTMLWindow) then
      HTMLWindow.execScript('setCookie("eJ_orig",'+airport_depart+',"longtime")', 'JavaScript');
//    paramWebBrowser.Navigate('javascript:',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    end;
    try
    if Assigned(HTMLWindow) then
      HTMLWindow.execScript('setCookie("eJ_orig_perm",'+airport_depart+',"longtime")', 'JavaScript');
//    paramWebBrowser.Navigate('javascript:setCookie("eJ_orig_perm",'+airport_depart+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
    ...
    try
    if Assigned(HTMLWindow) then
      HTMLWindow.execScript('setCookie("eJ_dest",'+airport_destination+',"longtime")', 'JavaScript');
//    paramWebBrowser.Navigate('javascript:setCookie("eJ_dest",'+airport_destination+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    Sleep(100);
    Application.ProcessMessages;
    except
...
//    paramWebBrowser.Navigate('javascript:setCookie("eJ_dest_perm",'+airport_destination+',"longtime");',EmptyParam,EmptyParam,EmptyParam,Headers);
    ...
    until paramWebBrowser.ReadyState >= READYSTATE_COMPLETE;
    // Naviagate to source page
    paramWebBrowser.Navigate(EasyjetMainURL, EmptyParam, EmptyParam, PostData, Headers);
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    Sleep(10);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            until IsSuccess or (abs(ticks - getTickCount)>3000);
...
begin
  ...
  then begin
//    PVariant(VarResult)^ := Integer(DLCTL_NO_JAVA or DLCTL_NO_SCRIPTS or DLCTL_DLIMAGES);
    //Result:= S_OK;
  end
