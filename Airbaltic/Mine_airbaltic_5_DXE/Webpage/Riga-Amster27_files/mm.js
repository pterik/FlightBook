...
function Slider(min, max, width, callback, callbackstop)
{
  var _minimumVal = min;
  var _maximumVal = max;
  var _width = width;
  var _callback = callback;
  var _callbackstop = callbackstop;
  ...
  _leftCap.style.backgroundImage = 'url( https://www.airbaltic.com/img/bti/mm/arrow_left.gif)';
  _leftCap.style.backgroundRepeat = 'no-repeat';
  _leftCap.style.position = 'absolute';
  _leftCap.style.height = '14px';
  _leftCap.style.width = '14px';
  _leftCap.style.left = '-20px';
  _leftCap.style.top = '3px';
  _leftCap.style.zIndex = 2;

  var _bar = document.createElement("DIV");
  _bar.style.backgroundColor = '#FCFCFC';
  _bar.style.position = 'absolute';
  _bar.style.height = '13px';
  _bar.style.width = (_width +17) + 'px';
  _bar.style.zIndex = 1;
  _bar.style.left = '-7px';
  _bar.style.top = '4px';

  var _rightCap = document.createElement("DIV");
  _rightCap.style.backgroundImage = 'url( https://www.airbaltic.com/img/bti/mm/arrow_right.gif)';
  _rightCap.style.backgroundRepeat = 'no-repeat';
  _rightCap.style.position = 'absolute';
  _rightCap.style.height = '14px';
  _rightCap.style.width = '14px';
  _rightCap.style.left = (_width+9) + 'px';
  _rightCap.style.top = '3px';
  _rightCap.style.zIndex = 2;

  var _pointer = document.createElement("DIV");
  _pointer.style.backgroundImage = 'url( https://www.airbaltic.com/img/bti/mm/slider_button.gif)';
  _pointer.style.position = 'absolute';
  _pointer.style.height = '17px';
  _pointer.style.width = '15px';
  _pointer.style.top = '0px';
  _pointer.style.zIndex = 3;
  ...
  var _pointerLB = new Position(-6, 0);
  var _pointerUB = new Position(_width-6, 0);

  var _pointerDrag = new dragObject(_pointer, _container, _pointerLB, _pointerUB, OnDragBegin, OnDrag, OnDragEnd, true);
  ...
  function UpdatePointerPos()
  {
    ...
    if(_maximumVal != _minimumVal)
      _pointer.style.left = (((_currentValue -  _minimumVal) / (_maximumVal - _minimumVal)) * _width - 6) + 'px';
    else
