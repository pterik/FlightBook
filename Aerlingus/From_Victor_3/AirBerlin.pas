...
uses
  ...
  INIFiles, Variants, unit1;

const   AirBerlinStartURL : widestring = 'http://www.airberlin.com/booking/flight/vacancy.php';
  DaysPerQuery = 5; //
...
ParamWebBrowser.Visible := false;
  ...
  depart_date_dt := 0;
    ...
    StartUrl:=AirBerlinStartURL+'?'+EncodedDataString;
      paramWebBrowser.Navigate(StartUrl,EmptyParam, EmptyParam, EmptyParam, Headers);
    // Wait while page is loading...
    repeat
      Application.HandleMessage;
      Sleep(10);
...
//        end;
        ...
        begin
          ...
          paramWebBrowser.Navigate(
              NextFlightsButtonLink,EmptyParam, EmptyParam, EmptyParam, Headers);
          // Wait while page is loading...
          repeat
          Application.HandleMessage;
          Sleep(10);
