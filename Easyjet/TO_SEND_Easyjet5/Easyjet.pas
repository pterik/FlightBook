...
//
    ...
    begin
      ...
      paramWebBrowser.Navigate(EasyjetStartURL, Flags, EmptyParam, PostData, Headers);
      Writeln(F, EasyjetStartURL);
...
//
    ...
    // Naviagate to source page
    paramWebBrowser.Navigate(EasyjetMainURL, Flags, EmptyParam, EmptyParam, Headers);
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    Sleep(10);
...
{    // Naviagate to source page
    paramWebBrowser.Navigate(EasyjetStartURL, Flags, EmptyParam, EmptyParam, Headers);
    Writeln(F,EasyjetStartURL);
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    ...
    // Naviagate to source page
    paramWebBrowser.Navigate(EasyjetStartURL+'?'+EncodedDataString, Flags, EmptyParam, EmptyParam, Headers);
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    Sleep(10);
...
//             UpperCase((DocSelectA.Item(a_index,EmptyParam) as IHTMLElement).className)) > 0 then
            begin
              ...
              Str := DocElementA.innerHTML;
              if (Pos('SAVE', UpperCase(Str))>0) or
                 (Pos('SALE', UpperCase(Str))>0) then
                paramOutData.add(
...
//
    ...
    // Naviagate to source page
{    paramWebBrowser.Navigate(EasyjetStartURL, Flags, EmptyParam, EmptyParam, Headers);
    Writeln(F,string(EasyjetStartURL));
    // Wait while page is loading...
    repeat
    Application.HandleMessage;
    Sleep(10);
