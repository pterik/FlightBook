  ...
  begin
    ...
    begin
      ...
      repeat
        ...
        ts.Text:= paramWebBrowser.OleObject.Document.documentElement.innerHTML;
        ts.SaveToFile(ParamStr(0) + '_test.html');
        FreeAndNil(ts);
            IsSuccess := true;
            Result := DocElement;
            break;
...
//         else
      ...
      Doc.close;
//      strl_forward.SaveToFile(ParamStr(0) + 'strl_forward.txt');
//      strl_return.SaveToFile(ParamStr(0) + 'strl_return.txt');
      paramOutData.SaveToFile(ParamStr(0) + 'paramOutData1.txt');
